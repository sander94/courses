                ...
                @foreach($result as $property)
                    ...
                    <div class="row mt-5">
                        <div class="col-12 col-md-3">
                           <a href="{{ route('properties.show', ['slug' => $property->slug]) }}" style="text-decoration: none;"><h3 class="text-orange hidedesktop">{{ $property->name }}</h3></a>
                        ...
                        <div class="col-12 col-md-9">
                            <a href="{{ route('properties.show', ['slug' => $property->slug]) }}" style="text-decoration: none;"><h3 class="text-orange hidemobile">{{ $property->name }}</h3></a>
