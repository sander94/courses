...
<div class="content">
	...
	<div class="row">
	    <div class="col-12 pt-4">
	    	...
	    	<img src="{{ asset('images/koolitused.svg') }}" style="position: absolute; top: 0; z-index: -1; right: 0; width: 80%;">
	    </div>
	</div>
    ...
    <div class="row mt-10 text-center">
    	...
    	<div class="col-12">
    		...
    		<div class="popular-courses-container">
	    		...
	    		<a href="#">TRANSPORT JA LOGISTIKA</a>
...
<div class="card-rounded mt-10">
    <div class="row">
	    	...
	    	<div class="col-9">
	    		...
	    		<p>Palun võtke meiega meilitsi ühendust info@koolitused.ee. Teeme Teile personaalse pakkumise Koolitused.ee andmebaasiga liitumiseks.</p>
	    	</div>
